<div class="navbar_dash">
    ...
    <ul class="d-flex flex-column gap-3">
        <li><a href="{{route('overview')}}" data-type="admin"><i class="fa-solid fa-house"></i> Overview</a></li>
        <li><a href="" data-type="artisan"><i class="fa-solid fa-user-tie"></i> Artisan</a></li>
