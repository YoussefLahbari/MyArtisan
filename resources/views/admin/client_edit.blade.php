...
<div class="container_">
    <h4 class="title_create">Edit client</h4>
    <form action="{{route('admin.client.update',$data->id)}}" method="post" class="mt-4">
        @csrf
        @method('PUT')
        <div class="row mb-5">
            <div class="col">
            ...
            <div class="col">
                ...
                <input type="text" name="email" id="name" class="form-control" placeholder="please enter a email" value="{{old('email',$data->email)}}">
                @error('email')
                <p class="mb-0 mt-1 px-1 text-danger">
                    <i class="fa-solid fa-circle-exclamation"></i>
                    {{$message}}
