...
<body>
    ...
    <div class="page-main">
        ...
        <section class="popular_project position-relative">
            <div class="container">
            ...
            <img src="{{asset('images/shape_4.svg')}}" alt="shape" class="shape_4">
        </section>
            ...
            <div class="container">
                <div class="inf position-relative d-flex align-items-center mx-auto">
                    <div class="box_inf">
                        <h3>How it Works</h3>
                        <div class="par">
                            <p><span>1</span> Choose a Tasker by price, skills, and reviews.</p>
                            <p><span>2</span> Schedule a Tasker as early as today.</p>
                            <p><span>3</span> Chat, pay, tip, and review all in one place.</p>
                        </div>
                    </div>
                    <img src="{{asset('images/how_it_work.avif')}}" alt="">
                </div>
            </div>
        </section>
        <footer class="footer py-4" style="background-color: #15143C;">
            <div class="container text-center text-light">
                <h3>Artisan</h3>
                <p class="mt-3">Experience the ease and quality of Artisan services. Sign up today and let us take the work out of your home tasks!</p>
                <ul>
